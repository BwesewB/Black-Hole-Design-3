...
const VideoBackground = forwardRef(({ src, loop = false, onVideoEnd }, ref) => {
  ...
  useImperativeHandle(ref, () => ({
    ...
    playNextVideo(newSrc, newLoop, onEndCallback) {
        ...
        console.log(`Starting transition: ${newSrc}`);
        ...
        let retryCount = 0; // Limit retries to prevent infinite loops
          ...
          setTimeout(() => {
            ...
            if (onEndCallback) {
              transitionVideo.onended = () => {
                ...
                console.log("Video ended:", newSrc);
                onEndCallback();
              };
            }
        ...
        const handleError = () => {
          ...
          retryCount++;
          if (retryCount > 3) {
            console.error("Failed to load video after 3 attempts:", newSrc);
            setIsTransitioning(false);
            return;
          }
          setTimeout(() => transitionVideo.load(), 1000); // Retry after 1s
        };
