...
export default function Home({}) {
  ...
  const getTransitionVideo = (currentVideo) => {
    if (currentVideo.src.includes("Clip9")) return "/videos/Clip13.mp4";
    if (currentVideo.src.includes("Clip11")) return "/videos/Clip14.mp4";
    if (currentVideo.src.includes("Clip7")) return "/videos/Clip15.mp4";
    return "";
  };
