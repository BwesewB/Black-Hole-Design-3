...
export default function Home({}) {
  ...
  const [currentVideo, setCurrentVideo] = useState("/videos/Clip1.mp4");
    ...
    <>
      ...
      <div>
        {currentPage === "LandingPage" && (
          <LandingPage onClickHandler={(nextPage) => handleNextPage(nextPage, "/videos/Clip2.mp4")} />
        )}
        {currentPage === "PageOne" && (
          <PageOne handleNext={(nextPage) => handleNextPage(nextPage, "/videos/Clip3.mp4")} />
        )}
